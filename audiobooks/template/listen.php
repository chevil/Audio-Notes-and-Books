...
<?php
$resultdb=db_query("SELECT data, excerpt FROM audiobook, annotation WHERE audiobook.aoid=annotation.id AND audiobook.title='".urlencode($title)."' ORDER BY audiobook.norder" );
